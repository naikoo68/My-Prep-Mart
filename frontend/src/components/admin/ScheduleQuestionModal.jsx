...
export default function ScheduleQuestionModal({ open, question, onClose }) {
  ...
  // configured, it uses the server-rendered image (which bakes in the watermark).
  // Otherwise, it uses a local screenshot of the card (exact math rendering).
  ...
  // its own image with the watermark — so we can skip the capture entirely.
